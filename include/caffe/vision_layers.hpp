...
template <typename Dtype>
class CroppingLayer : public Layer<Dtype> {
 public:
  explicit CroppingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void SetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
...
template <typename Dtype>
class L1NormLossLayer : public Layer<Dtype> {
 public:
...
template <typename Dtype>
class L1NormLayer : public Layer<Dtype> {
 public:
  explicit L1NormLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void SetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
